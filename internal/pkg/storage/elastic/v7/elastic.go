...
const (
	...
	ErrorIndex = "app_microservice-error-log-green"
	ErrorAlias = "error-log"

	SystemIndex = "app_microservice-system-log-green"
...
func (e *Elastic) Create(ctx context.Context, message app_microservice.LogMessage, id string, Index string) (string, error) {
